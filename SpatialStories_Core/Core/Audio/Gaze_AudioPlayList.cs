...
[System.Serializable]
public class Gaze_AudioPlayList : System.Object
{
    ...
    {
        // HACK: Done that in order to make Audioclips in Unity 2018 (I suspect that this object creation is not necessary)
        // TODO: Consider stop creating this Audioclips (They are not directly used) 
        AudioClip a = AudioClip.Create("MyClip", 4, 4, 4, true);
        Add(i, a);
        return a;
    }
